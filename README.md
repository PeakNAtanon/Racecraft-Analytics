...
ตั้ง `WEB_SEASONS=2026` เพื่อซ่อนตัวเลือกและ route ของฤดูกาล 2023–2025 บนเว็บชั่วคราว โดยไม่ลบข้อมูลใน storage; ลบค่าหรือใส่รายการปีที่ต้องการเพื่อเปิดกลับภายหลัง
